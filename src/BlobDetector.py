...
class BlobDetector(object):
    ...
    def _adaptive_thresh_slice(self, img, s=None, t=None):
    ...
    def _adaptive_thresh(self, img):
        self.threshold = 7500 #dummy code
        ...
        for z in range(img.shape[0]):
            ...
            th_img_slice = self._adaptive_thresh_slice(img_slice)
    ...
    def get_blob_centroids(self):
        ...
        gm_img = self._adaptive_thresh(self.img)
